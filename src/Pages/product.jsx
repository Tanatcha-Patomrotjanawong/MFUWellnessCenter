        ...
        <div className="product-grid">
          {products.map((product, index) => (
            <div key={index} className="product-card">
              ...
              <h3>{product.name}</h3>
              <p className="product-price">฿{product.price.toLocaleString()}</p> {/* Display price in Thai Baht */}
      ...
      {isModalOpen && (
        <div className="modal">
          <div className="modal-content">
            ...
            <p>Price: ฿{selectedProduct.price.toLocaleString()}</p> {/* Display price in Thai Baht */}
